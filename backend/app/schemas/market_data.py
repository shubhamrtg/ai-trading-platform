...
class Candle(BaseModel):
    ...
    vwap: Optional[Decimal] = Field(None, description="Volume Weighted Average Price if available")
    trades: Optional[int] = Field(None, ge=0, description="Number of individual trades")
