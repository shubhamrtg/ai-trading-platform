...
from app.strategies.sdk import Strategy, StrategyContext
...
class StrategyRunner:
    ...
    def __init__(self, strategy_class: type[Strategy[Any]], parameters_dict: dict[str, Any]):
    ...
    def process_candle(self, candle: Candle) -> Signal | None:
        ...
        try:
            ...
            # After processing the candle, append it to history.
            # This ensures the strategy has access to past candles,
            # and current candle is passed in as argument.
            context.history.append(candle)
