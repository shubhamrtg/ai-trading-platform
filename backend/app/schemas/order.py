...
from app.models.enums import OrderSide, OrderType, TimeInForce, OrderState
...
class OrderIntent(BaseModel):
    ...
    limit_price: Optional[Decimal] = Field(None, description="Required if LIMIT or STOP_LIMIT")
    stop_price: Optional[Decimal] = Field(None, description="Required if STOP_MARKET or STOP_LIMIT")
...
class Order(BaseModel):
    ...
    broker_order_id: Optional[str] = Field(None, description="ID returned by the broker")
...
class Fill(BaseModel):
    ...
    slippage: Optional[Decimal] = Field(None, description="Calculated slippage from expected price")
